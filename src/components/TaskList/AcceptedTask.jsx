    ...
    return (
        <>
            ...
            <div className='flex justify-between mt-4'>
                <button className='bg-green-500 py-1 px-2 m-2 text-white text-sm rounded-lg'>Mark as Completed</button>
                <button className='bg-red-500 py-1 px-2 m-2 text-white text-sm rounded-lg'>Mark as Failed</button>
            </div>
            </div>
